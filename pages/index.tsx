...
const IndexPage = () => {
  ...
  const base = new Airtable({
    apiKey:
      "patbsE6ntZcABcqC4.2115f9398fd6740af13ea5bc719ee45d2422fe4f1c57c04a5f28864bab8bb49f",
  }).base("appUjLVs0lBFVbgqB");

  const handleSubmit = async (e) => {
    e.preventDefault();
    const dateCollected = new Date().toISOString().split("T")[0];
    try {
      const record = await base("tblY3LEO7KxTh9YFu").create({
        "Email Address": email,
      ...
      <div className="relative z-10 py-6 space-y-16 lg:space-y-32 text-gray-900">
        <div className="text-center space-y-10">
          ...
          <p className="text-xl lg:text-2xl tracking-wide mx-10 lg:max-w-xl lg:mx-auto">
            We are under construction. Check back for an update soon. Stay in
            touch!
          </p>
        </div>
        <form
